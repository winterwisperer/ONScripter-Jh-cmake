...
void ONScripter::initSDL()
{
    ...
    screen_device_width  = screen_width*windows_scale;
    screen_device_height = screen_height*windows_scale;
    ...
    screen_scale_ratio1 = 1.0; //(float)screen_width / screen_device_width;
    screen_scale_ratio2 = 1.0;//(float)screen_height / screen_device_height;
